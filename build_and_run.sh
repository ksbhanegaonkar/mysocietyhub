...
# -------------------------
PROJECT_ROOT=$(pwd)
JAR_NAME="societyhub.jar"
IMAGE_NAME="society-hub-app:latest"
CONTAINER_NAME="society-hub"
APP_PORT=8080
...
BUILT_JAR=$(find target -maxdepth 1 -type f -name "societyhub-*.jar" ! -name "*-plain.jar" | head -n 1)
if [[ -z "$BUILT_JAR" ]]; then
